...
const NotFound = () => {
  return (
    <StyledWrapper>
      ...
      <h1 style={{ color: "brown", fontSize: "2em", fontWeight: "bold", marginBottom: "2em" }}>
            Click here to read the amazing blogs
        </h1>
        <a href="/blogs"
        style={{ textDecoration: "none", color: 'white', fontSize: "1.5em", fontWeight: "bold" ,padding:"6px",backgroundColor:"#cda37b", borderRadius:"5px"}}>
        Click here</a>
    </StyledWrapper>
  );
}
